...
export function change_offer_request() {
  return { type: types.CHANGE_OFFER_REQUEST }
}

export function change_offer_response() {
  return { type: types.CHANGE_OFFER_RESPONSE }
}
